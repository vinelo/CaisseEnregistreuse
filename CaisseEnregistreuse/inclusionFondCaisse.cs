...
namespace CaisseEnregistreuse
{
    public partial class inclusionFondCaisse : Form
    {
        ...
        private void Change()
        {
            ...
            tbxTotal.Text = Convert.ToString(1000 * FR1000 + 200 * FR200 + 100 * FR100 + 50 * FR50 + 20 * FR20 + 10 * FR10 + 5 * FR5 + 2 * FR2 + 1 * FR1 + 0.5 * FR05 + 0.2 * FR02 + 0.1 * FR01 + 0.05 * FR005) + " Fr";
        }
        ...
        {
            C.InclureFondDeCaisse(FR1000, FR200, FR100, FR50, FR20, FR10, FR5, FR2, FR1, FR05, FR02, FR01, FR005);
        }
